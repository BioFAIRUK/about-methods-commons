...
<div class="bf-hero bf-grid">
  <span class="bf-eyebrow">BioFAIR · Methods Commons</span>
  <h1 class="mt-2">FAIR computational workflows for UK life science.</h1>
...
<div class="row row-cols-1 row-cols-md-2 g-4 my-2">
  ...
  <div class="col"><div class="p-4 bf-bg-grey rounded-3 h-100">
    ...
    <h4 class="mt-2">Workflow discovery</h4>
    <p class="mb-0">WorkflowHub as the single access point for finding, sharing and reusing workflows across languages, hosting a curated <em>BioFAIR Workflow Collection</em> of endorsed, canonical workflows.</p>
  </div></div>
  <div class="col"><div class="p-4 bf-bg-grey rounded-3 h-100">
...
Space and Observatory), the **Earlham Institute** (Galaxy and cloud
infrastructure), and **Seqera** (Nextflow and community). Together they
originated Taverna, CWL, myExperiment and WorkflowHub, operate Galaxy at
scale, and founded Nextflow and nf-core.

<div class="row row-cols-1 row-cols-md-3 gy-4 navigation-tiles mt-2">
  <div class="col d-grid">
    <a role="button" class="btn py-4 section-title" href="{{ '/about' | relative_url }}">
      About
      <span class="d-block fs-6 fw-normal mt-2 text-muted">Goals, objectives and how it's delivered.</span>
    </a>
  </div>
  <div class="col d-grid">
    <a role="button" class="btn py-4 section-title" href="{{ '/use-cases' | relative_url }}">
      Exemplar Use Cases
      <span class="d-block fs-6 fw-normal mt-2 text-muted">Nine real research problems driving development.</span>
    </a>
  </div>
  <div class="col d-grid">
    <a role="button" class="btn py-4 section-title" href="{{ '/team' | relative_url }}">
      The team
      <span class="d-block fs-6 fw-normal mt-2 text-muted">The people and partners behind the Commons.</span>
    </a>
  </div>
</div>
