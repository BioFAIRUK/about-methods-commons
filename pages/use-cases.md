...
permalink: /use-cases
sidebar: main
summary: Nine real research problems that co-create, stress-test and seed the Methods Commons.
---
...
|---|---|---|---|---|
| 1 | Bioimaging | Dundee / Bioimaging UK | Galaxy, WorkflowHub, OME-Zarr, RO-Crate, BioImage Model Zoo | FAIR, domain-agnostic imaging workflows; streaming multi-terabyte datasets and democratising AI image-analysis models |
| 2 | Single-cell genomics (livestock) | Roslin Institute | Nextflow, StarSolo, CellBender, Parse, 10X Genomics | Standardised pipelines for non-model species (fish, birds, livestock) with complex genomes |
| 3 | Single-cell workflow training | Open University | Galaxy, Intergalactic Workflow Commission, WorkflowHub | Adaptable workflows and live training for researchers at under-resourced institutions |
...
extensibility. The set is cycled or extended over time as new needs emerge
from BioFAIR Fellows, Pathfinder projects and the wider community.
